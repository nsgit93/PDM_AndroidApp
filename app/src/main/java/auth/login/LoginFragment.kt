...
import com.example.childrencompetition.R.layout
import core.Api
import core.Result
    ...
    private fun setupLoginForm() {
        ...
        viewModel.loginResult.observe(viewLifecycleOwner, { loginResult ->
            ...
            if (loginResult is Result.Success<*>) {
                findNavController().navigate(R.id.action_fragment_login_to_fragment_participant_list);
                Api.tokenInterceptor.token?.let { WebSocketNotifications.initializeWebSocket(it) }
//                findNavController().navigate(R.layout.fragment_participant_list)
